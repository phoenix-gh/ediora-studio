  ...
  return (
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          {post.cover_image && sourceUrl ? <a href={sourceUrl} target="_blank" rel="noreferrer" className="mb-2 inline-block max-w-full align-top overflow-hidden rounded-lg border border-border"><img src={post.cover_image} alt="" loading="lazy" referrerPolicy="no-referrer" className="block h-auto max-h-[420px] max-w-full object-contain w-auto" onError={event => { (event.currentTarget.parentElement as HTMLElement).style.display = 'none' }} /></a> : null}
