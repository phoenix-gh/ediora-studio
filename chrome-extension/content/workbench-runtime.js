...
const STATIC_UI = [
  ...
  '.sw-preview-head { min-width: 0; padding-bottom: 17px; }',
  ...
  '.sw-preview-divider { height: 1px; background: linear-gradient(90deg, rgba(103, 232, 249, .38), rgba(99, 102, 241, .18), transparent); }',
  ...
  '@media (max-width: 720px) { .sw-entry { right: 16px; bottom: 16px; } .sw-panel { right: 8px; bottom: 74px; width: calc(100vw - 16px); height: calc(100vh - 90px); max-width: none; max-height: none; } .sw-body { grid-template-columns: minmax(0, 1fr); grid-template-rows: minmax(205px, 34%) minmax(0, 1fr); } .sw-sidebar { border-right: 0; border-bottom: 1px solid rgba(148, 163, 184, .14); } .sw-preview { padding: 19px 17px 16px; } .sw-settings { right: 8px; left: 8px; width: auto; } }',
  '</style>',
  '<div class="sw-root">',
  ...
  '<article data-role="preview" hidden>',
