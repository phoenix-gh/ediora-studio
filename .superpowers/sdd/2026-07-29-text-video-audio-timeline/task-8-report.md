...
- real media URLs, truthful audio states, voice controls, confirmation races,
  speakable-only master gating, and master retry behavior;
- frozen split-preview sessions and exact durable-step failures.

## Verification

- Frontend unit/integration suite: `pnpm test` — 91 files, 482 tests passed
